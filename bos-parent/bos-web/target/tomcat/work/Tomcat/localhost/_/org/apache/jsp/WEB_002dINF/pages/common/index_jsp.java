 ...
 * Generated at: 2017-07-21 12:21:29 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t$(\"#txtNewPass\").blur(function(newPwd){\r\n");
      out.write("\t\t\t\tif(newPwd==\"\" || newPwd.length<3|| newPwd.length>16){\r\n");
      out.write("\t\t\t\t//\tif(/\\s/.test(newPwd)){\r\n");
      out.write("\t\t\t\t\t\t$.messager.alert('警告','密码不能为空,不能出现空格,且必须是3-16位数字获取者字母!','warning');  \r\n");
      out.write("\t\t\t\t\t\t//$(\"#txtNewPassError\").html(\"密码不能为空,不能出现空格,且必须是3-16位数字获取者字母\");\t\r\n");
      out.write("\t\t\t\t//\t}\r\n");
      out.write("\t\t\t\t\treturn ;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t$(\"#txtRePass\").blur(function(newPwd,rePwd){\r\n");
      out.write("\t\t\t\tif(newPwd!=rePwd){\r\n");
      out.write("\t\t\t\t\t$.messager.alert('错误信息','两次密码不匹配，请重新输入!','error');  \r\n");
      out.write("\t\t\t\t\t//$(\"#txtNewPassError\").html(\"两次密码不匹配，请重新输入\");\t\r\n");
      out.write("\t\t\t\t\t$(\"#txtNewPass\").html(\"\");\r\n");
      out.write("\t\t\t\t\t$(\"#txtRePass\").html(\"\");\r\n");
      out.write("\t\t\t\t\treturn ;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write("\t\t\t\t//var b = regex.test(newPwd);\r\n");
      out.write("\t\t\t//\talert(b);\r\n");
      out.write("\t\t\t\t//\tif(/\\s/.test(newPwd)){\r\n");
      out.write("\t\t\t\t\t\t$.messager.alert('警告','密码不能为空,不能出现空格,且必须是3-16位数字获取者字母!','warning');  \r\n");
      out.write("\t\t\t\t\t\t//$(\"#txtNewPassError\").html(\"密码不能为空,不能出现空格,且必须是3-16位数字获取者字母\");\t\r\n");
      ...
      out.write("\t\t\t\t$.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/user/user_editPassword\",{\"newPwd\":newPwd,\"rePwd\":rePwd},function(data){\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t//alert(data);\r\n");
      out.write("\t\t\t\t\tif(data){\r\n");
      out.write("\t\t\t\t\t\t$.messager.alert('成功','恭喜您修改成功!','info');  \r\n");
      out.write("\t\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t\t$.messager.alert('错误信息','修改密码错误!','error');  \r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t$('#editPwdWindow').window('close');\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t<!-- \t<div title=\"搜索框\" data-options=\"iconCls:'icon-mini-add'\" style=\"overflow:auto\">  \r\n");
      out.write("\t\t\t\t\t\t<input id=\"ss\" class=\"easyui-searchbox\" style=\"width:300px\" data-options=\"searcher:qq,prompt:'请输入您要搜索的值',menu:'#mm'\"></input> \r\n");
      out.write("\t\t\t\t\t\t<div id=\"mm\" style=\"width:120px\"> <div data-options=\"name:'all',iconCls:'icon-ok'\">All News</div> \r\n");
      out.write("\t\t\t\t\t\t<div data-options=\"name:'sports'\">Sports News</div> </div>\r\n");
      out.write("\t\t\t</div> -->\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("                    <tr>\r\n");
      out.write("                        <td>新密码：</td>\r\n");
      out.write("                        <td><input id=\"txtNewPass\" type=\"text\" class=\"txt01\" />\r\n");
      out.write("                        </td>\r\n");
      out.write("                    </tr>\r\n");
      out.write("                    <tr>\r\n");
      out.write("                        <td>确认密码：</td>\r\n");
      out.write("                        <td><input id=\"txtRePass\" type=\"text\" class=\"txt01\" /></td>\r\n");
      out.write("                    </tr>\r\n");
      out.write("                </table>\r\n");
      out.write("            </div>\r\n");
