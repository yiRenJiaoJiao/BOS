 ...
 * Generated at: 2017-07-23 08:52:00 UTC
...
public final class subarea_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\ta.push(arr[i].id);\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tvar ids = a.join(',');\r\n");
      out.write("\t\t\t$.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/bc/subarea_deleteSubarea\",{\"ids\":ids},function(data){\r\n");
      out.write("\t\t\t\tif(data){\r\n");
      out.write("\t\t\t\t\t$.messager.alert('通知','删除成功','info'); \r\n");
      out.write("\t\t\t\t\t$('#grid').datagrid('reload');\r\n");
      out.write("\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t$.messager.alert('通知','删除失败','info'); \r\n");
      out.write("\t\t\t\t\t$('#grid').datagrid('reload');\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t}else{\r\n");
      out.write("\t\t\t$.messager.alert('通知','您还没有选中要删除的项，请选中后再操作','info'); \r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t/* \t$.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/bc/subarea_export\",function(data){\r\n");
      out.write("\t\t\tif(data){\r\n");
      out.write("\t\t\t\t$.messager.alert('通知','导出数据成功','info');  \r\n");
      out.write("\t\t\t}else{\r\n");
      out.write("\t\t\t\t$.messager.alert('通知','导出数据失败','info');  \r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}) */\r\n");
      out.write("\t\t\r\n");
      out.write("\t}\r\n");
      ...
      out.write("\t\t$.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/bc/subarea_saveEdit\",rowData,function(data){\r\n");
      out.write("\t\t\tif(data){\r\n");
      out.write("\t\t\t\t$.messager.alert('通知','数据保存成功','info');  \r\n");
      out.write("\t\t\t}else{\r\n");
      out.write("\t\t\t\t$.messager.alert('通知','数据保存失败','info');  \r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\t\t\t \"decidedzone.id\":$(\"#qdecidedzone\").val(),\"addresskey\":$(\"#qaddresskey\").combobox('getValue')};\r\n");
      ...
      out.write("\t            action: '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/bc/subarea_uploadSubArea',\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t\t//校验编码是否唯一\r\n");
      out.write("\t\t/* $(\"input[name=id]\").blur(function(){\r\n");
      out.write("\t\t\t$.post(\"\",{},function(data){\r\n");
      out.write("\t\t\t\tif(data){\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t$.messager.alert('通知','编码已经存在','info');  \r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t}) */\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t//将查询表单的数据转换成json格式\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t//条件查询\r\n");
      out.write("\t\t \t$(\"#querybtn\").click(function(){\r\n");
      out.write("\t\t \t\tvar qjson = $(\"#searchForm\").serializeJson();\r\n");
      out.write("\t\t\t\t$('#grid').datagrid('load',qjson);  \r\n");
      out.write("\t\t\t\t$(\"#searchWindow\").window(\"close\");\r\n");
      out.write("\t\t\t}); \r\n");
      out.write("\t\t\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/bc/subarea_saveSubarea\" method=\"post\">\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/bc/region_findRegionsList'\" />  \r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td>关键字</td>\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/bc/subarea_export\" method=\"post\">\r\n");
      out.write("\t\t\t\t<table class=\"table-edit\" width=\"80%\" align=\"center\">\r\n");
      out.write("\t\t\t\t\t<tr class=\"title\">\r\n");
      ...
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=\"2\"><a id=\"querybtn\" href=\"#\" class=\"easyui-linkbutton\" data-options=\"iconCls:'icon-search'\">查询</a> </td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t</table>\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\t\t</div>\r\n");
