 ...
 * Generated at: 2017-07-27 11:25:45 UTC
...
public final class noticebill_005fadd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t$.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/qp/noticebill_findOneCustomer\",{\"telephone\":this.value},function(data){\r\n");
      out.write("\t\t\t\tif(data!=null){\r\n");
      out.write("\t\t\t\t\t$(\"#customerId\").show();\r\n");
      out.write("\t\t\t\t\t$(\"#customerId\").removeAttr('readonly');\r\n");
      out.write("\t\t\t\t\t$(\"#customerId\").val(data.customerId);\r\n");
      out.write("\t\t\t\t\t$(\"#customerName\").val(data.customerName)\r\n");
      out.write("\t\t\t\t\t$(\"#tel_msg\").html(\"<font color='red'>老用户</font>\");\r\n");
      out.write("\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t$(\"#customerId\").attr('readonly',true);\r\n");
      out.write("\t\t\t\t\t$(\"#customerId\").hide();\r\n");
      out.write("\t\t\t\t\t$(\"#customerId\").val(\"\");\r\n");
      out.write("\t\t\t\t\t$(\"#customerName\").val(\"\");\r\n");
      out.write("\t\t\t\t\t$(\"#tel_msg\").html(\"<font color='gerren'>新用户</font>\");\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t});\r\n");
      ...
      out.write("\r\n");
      out.write("\t\tuniqueTelephone: { \r\n");
      out.write("\r\n");
      out.write("\t\tvalidator: function(value,param){ \r\n");
      out.write("\t\t\tvar flag ;\r\n");
      out.write("\t\t\t$.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/qp/noticebill_uniqueTelephone\",{\"telephone\":value},function(data){\r\n");
      out.write("\t\t\t\tif(data){\r\n");
      out.write("\t\t\t\t\tflag = true;\r\n");
      out.write("\t\t\t\t}else{\r\n");
      ...
      out.write("\t\t}, \r\n");
      out.write("\r\n");
      out.write("\t\tmessage: '您输入的号码不唯一' \r\n");
      out.write("\r\n");
      out.write("\t\t} \r\n");
      out.write("\r\n");
      out.write("\t\t}); \r\n");
      out.write("\r\n");
      out.write("\t,validType:uniqueTelephone */\r\n");
      out.write("\r\n");
      out.write("\tfunction submitForm(){\r\n");
      out.write("\t\tvar flag = $(\"#noticebillForm\").form('validate');\r\n");
      out.write("\t\tif(flag){\r\n");
      out.write("\t\t\t//提交后台的数据设置\r\n");
      out.write("\t\t\tvar province = document.getElementById(\"province\").selectedOptions[0].text;\r\n");
      out.write("\t\t\tvar city = document.getElementById(\"city\").selectedOptions[0].text;\r\n");
      out.write("\t\t\tvar district = document.getElementById(\"district\").selectedOptions[0].text;\r\n");
      out.write("\t\t\t$(\"#qprovince\").val(province);\r\n");
      out.write("\t\t\t$(\"#qcity\").val(city);\r\n");
      out.write("\t\t\t$(\"#qdistrict\").val(district);\r\n");
      out.write("\t\t\t$(\"#noticebillForm\").submit();\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\t<a id=\"save\" onclick=\"submitForm()\" icon=\"icon-save\" href=\"#\" class=\"easyui-linkbutton\" plain=\"true\">新单</a>\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/qp/noticebill_save\" method=\"post\">\r\n");
      ...
      out.write("\t\t\t\t\t<td><input type=\"text\" class=\"easyui-validatebox\" id=\"telephone\" name=\"telephone\"  data-options=\"required:true\" />\r\n");
      out.write("\t\t\t\t\t<span id=\"tel_msg\"></span>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t<td>客户编号:</td>\r\n");
      out.write("\t\t\t\t\t<td><input type=\"text\" class=\"easyui-validatebox\" id=\"customerId\"  name=\"customerId\" /></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td>客户姓名:</td>\r\n");
      out.write("\t\t\t\t\t<td><input type=\"text\" class=\"easyui-validatebox\" id=\"customerName\" name=\"customerName\" required=\"true\" /></td>\r\n");
      out.write("\t\t\t\t\t<td>联系人:</td>\r\n");
      out.write("\t\t\t\t\t<td><input type=\"text\" class=\"easyui-validatebox\" id=\"delegater\" name=\"delegater\" required=\"true\" /></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr class=\"title\">\r\n");
      ...
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td>品名:</td>\r\n");
      out.write("\t\t\t\t\t<td><input type=\"text\" class=\"easyui-validatebox\" id=\"product\" name=\"product\" required=\"true\" /></td>\r\n");
      out.write("\t\t\t\t\t<td>件数:</td>\r\n");
      out.write("\t\t\t\t\t<td><input type=\"text\" class=\"easyui-numberbox\" id=\"num\" name=\"num\" required=\"true\" /></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td>重量:</td>\r\n");
      out.write("\t\t\t\t\t<td><input type=\"text\" class=\"easyui-numberbox\" id=\"weight\" name=\"weight\" required=\"true\" /></td>\r\n");
      out.write("\t\t\t\t\t<td>体积:</td>\r\n");
      out.write("\t\t\t\t\t<td><input type=\"text\" class=\"easyui-validatebox\" id=\"volume\" name=\"volume\" required=\"true\" /></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td>取件地址</td>\r\n");
      out.write("\t\t\t\t\t<td colspan=\"3\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"hidden\" name=\"qprovince\" id=\"qprovince\"/>\r\n");
      out.write("\t\t\t\t\t\t<input type=\"hidden\" name=\"qcity\" id=\"qcity\"/>\r\n");
      out.write("\t\t\t\t\t\t<input type=\"hidden\" name=\"qdistrict\" id=\"qdistrict\"/>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
