 ...
 * Generated at: 2017-07-16 13:12:06 UTC
...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t class=\"loginFormTdIpt easyui-validatebox\" maxlength=\"50\"  data-options=\"validType:'email'\"/>\r\n");
      ...
      out.write("\t\t\t\t\t\t<input id=\"loginform:pwdInput\"  type=\"password\" class=\"easyui-validatebox\" data-options=\"required:true\" \r\n");
      ...
      out.write("\t\t\t\t\t\t\t<input id=\"loginform:codeInput\" class=\"loginFormTdIpt easyui-validatebo\" type=\"text\"\r\n");
      out.write("\t\t\t\t\t\t\t\tname=\"checkcode\" title=\"请输入验证码\"  data-options=\"required:true,validType:'email'\"/>\r\n");
      ...
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<a href=\"#\" id=\"login\" onclick=\"to_login()\" name=\"loginform:j_id19\" >\r\n");
      out.write("\t\t\t\t\t\t<span\r\n");
      out.write("\t\t\t\t\t\t\tid=\"loginByForm\" class=\"btn btn-login\"\r\n");
      out.write("\t\t\t\t\t\t\tstyle=\"margin-top:-36px;\">登录</span>\r\n");
      out.write("\t\t\t\t\t\t</a>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<span id=\"emailError\"></span>\r\n");
      out.write("\t\t\t\t\t\t<span id=\"pwdError\"></span>\r\n");
      out.write("\t\t\t\t\t\t<span id=\"checkCodeError\"></span>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t</form>\r\n");
      out.write("\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t$(\"#emailError\").html(\"用户名不能为空\");\r\n");
      out.write("\t\t\t\t\treturn ;\r\n");
      out.write("\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\tflag=true;\r\n");
      ...
      out.write("\t\t\t\tif($(this).val()!=\"\"||$(this).val()>6){\r\n");
      out.write("\t\t\t\t\tflag=true;\r\n");
      out.write("\t\t\t\t\t$(\"#pwdError\").html(\"\");\r\n");
      out.write("\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\tflag=false;\r\n");
      out.write("\t\t\t\t\t$(\"#pwdError\").html(\"密码不能为空\");\r\n");
      out.write("\t\t\t\t\treturn ;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t\r\n");
      ...
      out.write("\t\t\t\tif($(this).val()==\"\"){\r\n");
      out.write("\t\t\t\t\t$(\"#checkCodeError\").html(\"验证码不能为空\");\r\n");
      out.write("\t\t\t\t\t//$.messager.alert('错误','验证码不能为空!','error'); \r\n");
      out.write("\t\t\t\t\tflag=false;\r\n");
      out.write("\t\t\t\t\treturn ;\r\n");
      out.write("\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\tflag=true;\r\n");
      out.write("\t\t\t\t\t$(\"#checkCodeError\").html(\"\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\t$.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/user/user_checkCode\",{\"checkcode\" :this.value},function(data){\r\n");
      out.write("\t\t\t\t\tif(data){\r\n");
      out.write("\t\t\t\t\t\tflag=true;\r\n");
      out.write("\t\t\t\t\t\t$(\"#checkCodeError\").html(\"\");\r\n");
      out.write("\t\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t\tflag=false;\r\n");
      out.write("\t\t\t\t\t\t//$.messager.alert('错误','验证码输入有误!','error');  \r\n");
      out.write("\t\t\t\t\t\t$(\"#checkCodeError\").html(\"验证码输入有误\");\r\n");
      out.write("\t\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t});\r\n");
